...
(def style (css [:html {:background "black"
                        :color "white"
                        :font-size "85%"
                        :font-family "Consolas, \"Liberation Mono\", Courier, monospace"}]
                ;TODO: is this the correct syntax for .msg h1, .msg h3
                [:.msg :h1 :.msg :h3 {:font-weight 800
                                      :font-size "1em"
                                      :line-height "40px"
                                      :padding "10px 0 10px 20px"
                                      :background "green"}]
                [:.msg :h3 {:font-weight 600
                            :font-size "0.8em"
                            :line-height "30px"
                            :margin-top "10px"}]
                [:code {:margin "20px"}]
                [:.error-line {:background "#a60000"
                               :font-weight 800
                               :margin "10px 0"
                               :font-size "120%"
                               :padding "10px 0"}]
